        ...
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img src="{{ asset('client/images/nathan-mcbride-229637.jpg')}}" alt=""/></div>
                            <div></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img">
                                <img src="{{ asset('client/images/photo-1449157291145-7efd050a4d0e-578x362.jpg')}}" alt=""/>
                            </div>
                            <div></div>
                        </div>
                    </div>
                ...
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img src="{{ asset('client/images/office-768x512.jpg')}}" alt=""/></div>
                            <div></div>
                        </div>
                    </div>
                    <div class="col-md-7">
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <img src="{{ asset('client/images/download (1).jpg')}}" alt="img" class="fh5co_most_trading"/>
                    </div>
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <img src="{{ asset('client/images/allef-vinicius-108153.jpg')}}" alt="img" class="fh5co_most_trading"/>
                    </div>
                    <div class="col-7 paddding">
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <img src="{{ asset('client/images/download (2).jpg')}}" alt="img" class="fh5co_most_trading"/>
                    </div>
                    <div class="col-7 paddding">
                        <div class="most_fh5co_treding_font"> Magna aliqua ut enim ad minim veniam quis nostrud.</div>
                        <div class="most_fh5co_treding_font_123"> April 18, 2016</div>
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center"><img src="{{ asset('client/images/seth-doyle-133175.jpg')}}" alt="img"
...
<div class="container-fluid pb-4 pt-5">
    <div class="container animate-box">
        ...
        <div class="owl-carousel owl-theme" id="slider2">
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img"><img src="{{ asset('client/images/39-324x235.jpg')}}" alt=""/></div>
                    <div>
