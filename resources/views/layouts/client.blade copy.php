...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('client/client/assets/img/favicon.ico')}}">
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src="client/assets/img/logo/logo2_footer.png" alt=""></a>
                                </div>
