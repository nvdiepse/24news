                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-3 fh5co_padding_menu">
                            <a href="/"><img src="{{ asset('client/images/logo.png')}}" alt="img" class="fh5co_logo_width" /></a>
                        </div>
                        <div class="col-12 col-md-9 align-self-center fh5co_mediya_right">
                            ...
                            <!--<div class="d-inline-block text-center"><img src="{{ asset('client/images/country.png')}}" alt="img" class="fh5co_country_width"/></div>-->
            ...
            <div class="container-fluid bg-faded fh5co_padd_mediya padding_786">
                <div class="container padding_786">
                    <nav class="navbar navbar-toggleable-md navbar-light ">
                        ...
                        <a class="navbar-brand" href="#"><img src="{{ asset('client/images/logo.png')}}" alt="img" class="mobile_logo_width" /></a>
