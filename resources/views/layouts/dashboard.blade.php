...
<head>
    ...
    <title>Tcwatch.net - Hệ thống điện thoại chính hãng uy tín - giá tốt.</title>
...
<div id="wrapper">
    ...
    <!-- Sidebar -->
@include('layouts._share.admin.nav')
<!-- End of Sidebar -->
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="col-md-3 offset-md-9 alert alert-success alert-dismissible fade hide" id="alert_success"
                     role="alert">
                    <strong id="title_success">Holy guacamole!</strong> <span id="content_success">You should check in on some of those fields below.</span>
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <!-- <div class="col-md-3 offset-md-9 alert alert-warning alert-dismissible fade show" id="alert_danger" role="alert">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Development by Nvdiepse@gmail.com</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
